...
$serviceHealthresults = $SvcHealthAlerts.value | Select-Object -Property title,id,impactDescription,classification,featureGroup,service,status,startDateTime
